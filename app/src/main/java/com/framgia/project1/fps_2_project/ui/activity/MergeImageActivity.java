...
public class MergeImageActivity extends AppCompatActivity {
    ...
    private void findView() {
        ...
        mButtonAddImage.setOnClickListener(mClickListener);
        mButtonTransformCircle = (ImageButton) findViewById(R.id.button_transform);
        mButtonTransformCircle.setOnClickListener(mClickListener);
        mButtonTransformSquare = (ImageButton) findViewById(R.id.button_crop);
        mButtonTransformSquare.setOnClickListener(mClickListener);
        ...
        mButtonDone.setOnClickListener(mClickListener);
        mButtonReturn = (ImageButton) findViewById(R.id.button_return);
        mButtonReturn.setOnClickListener(mClickListener);
    }

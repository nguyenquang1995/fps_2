...
public class TextureRenderer implements Constant {
    ...
    public void init() {
        ...
        mPosCoordHandle = GLES20.glGetAttribLocation(mProgram, POSITION);
    ...
    public void renderTexture(int texId) {
        ...
        GLToolbox.checkGlError(USE_PROGRAM);
        GLES20.glViewport(0, 0, mViewWidth, mViewHeight);
        GLToolbox.checkGlError(VIEW_PORT);
        ...
        GLToolbox.checkGlError(SETUP_VERTEX);
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLToolbox.checkGlError(ACTIVE_TEXTURE);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, texId);
        GLToolbox.checkGlError(BIND_TEXTURE);
